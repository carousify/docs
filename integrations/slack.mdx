...
Each message includes the post title, the LinkedIn account it was posted to (or attempted on), the scheduled/published time, and a link back to the post in Carousify.
...
<Columns cols={2}>
  ...
  <Card title="MCP server" icon="robot" href="/mcp/overview">
    Drive Carousify from Claude or Cursor when notifications aren't enough.
  </Card>
</Columns>
